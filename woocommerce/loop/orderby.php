 ...
 *
 * This templates can be overridden by copying it to yourtheme/woocommerce/loop/orderby.php.
 *
...
<div class="ultraland-orderby-wrapper">
	<form class="woocommerce-ordering" method="get">
		<select name="orderby" class="orderby" aria-label="<?php esc_attr_e( 'Shop order', 'quiety' ); ?>">

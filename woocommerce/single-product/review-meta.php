<?php
/**
 * The templates to display the reviewers meta data (name, verified owner, review date)
 *
 * This templates can be overridden by copying it to yourtheme/woocommerce/single-product/review-meta.php.
 *

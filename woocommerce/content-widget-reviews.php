 ...
 *
 * This templates can be overridden by copying it to yourtheme/woocommerce/content-widget-reviews.php
 *
...
<li>
	...
	<span class="reviewer"><?php echo sprintf( esc_html__( 'by %s', 'quiety' ), get_comment_author( $comment->comment_ID ) ); ?></span>

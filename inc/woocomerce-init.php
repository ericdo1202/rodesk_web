...
if ( ! class_exists( 'Quiety_Woo_Support' ) ) {
	class Quiety_Woo_Support {
		...
		public function quiety_product_item_single_cart_open() {
			print '<div class="quiety-product-form">';
		}
		...
		public function quiety_product_item_wrapper_open() {
			...
			$product_style = quiety_option('product_style');

			print '<div class="quiety-product-item '. esc_attr($product_style) .'">';
		}
		...
		public function quiety_product_info_wrapper_open() {
			print '<div class="quiety-product-info">';
		}
		...
		public function quiety_woocommerce_template_loop_product_title() {
			...
			the_title( '<h3 class="quiety-product-list-title"><a href="' . get_the_permalink() . '">', '</a></h3>' );
		}
		...
		/**/
		/* Quiety Comments Form Filter */
		/**/
		public function quiety_filter_comments($comment_form){
		...
		/**
		 * Add Wrapper for My Account Page (Open)
		 * @sinsce 1.0.0
		 * */
		...
		/**
		 * Add Wrapper for My Account Page (Close)
		 * @sinsce 1.0.0
		 * */
		...
		/* Reviews filter */
		/**/
		public function filter_reviews($array) {
			return array( 'callback' => array( $this, 'quiety_templates_reviews' ) );
		}

		public function quiety_templates_reviews($comment, $args, $depth) {
		...
		/**/
		public function comments_fiels( $fields ){
			if( is_product() ) {

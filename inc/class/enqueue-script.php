...
class Quiety_Enqueue_Script {
    ...
    public function css_reg() {
        ...
        //============ Dynamic Inline Script's ==================//
        $dynamic_css = '';
        $meta = get_post_meta( get_the_ID(), 'tt_page_options', true );

        // === Menu Container Width
        $meta_header_container_width = !empty($meta['meta_header_container_width']) ? $meta['meta_header_container_width'] : '';
        if ( $meta_header_container_width ) {
            $dynamic_css .= "
                @media (min-width:1340px) {
                    .container {
                        max-width: {$meta_header_container_width}px !important;
                    }
                }
            ";
        }
        ...
        wp_add_inline_style( 'quiety-style_main', $dynamic_css );
    ...
    public function js_reg() {
        ...
        wp_enqueue_script('quiety-main', $this->gtdu . '/assets/js/app.js', array('jquery'), false, true);

        wp_enqueue_script('quiety-custom-script', $this->gtdu . '/assets/js/custom-script.js', array('jquery'), false, true);
    ...
    public function admin_css_reg() {
        ...
        wp_enqueue_style('quiety-admin', $this->gtdu . '/assets/css/admin.css');
    }

	...
	class Quiety_Theme_Support {
		...
		function quiety_setup() {
			...
			if ( function_exists( 'add_theme_support' ) ) {
				...
				add_image_size( 'quiety_blog_330x250', 330, 250, true );
				...
				add_image_size( 'quiety-portfolio_400x370', 400, 370, true );
				add_image_size( 'quiety-portfolio_600x600', 600, 600, true );
			}
		}

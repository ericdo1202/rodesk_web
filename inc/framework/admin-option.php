...
if ( class_exists( 'CSF' ) ) {
	...
	CSF::createOptions( $prefix, array(
		'menu_title'      => esc_html__( 'Theme Settings', 'quiety' ),
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
            ...
            array(
                'id'    => 'logo_dimension',
                'type'  => 'number',
                'title' => 'Logo Dimension',
                'desc'       => esc_html__( 'Set a custom height width for your upload logo.', 'quiety' ),
                'unit'        => 'px',
                'output'      => '.site-header .site-logo img',
                'output_mode' => 'width',
                'default'     => 100,
            ),
            ...
            //Button Normal Color
            array(
                'id'     => 'c2a_normal_text_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Button Text Color', 'quiety' ),
                'output' => array('header .nav-btn')
            ),

            array(
                'id'     => 'c2a_normal_bg_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Button Background Color', 'quiety' ),
                'desc'   => esc_html__( 'You can change menu text color.', 'quiety' ),
                'output' => array(
                    'background-color' => 'header .nav-btn',
                )
            ),

            array(
                'id'     => 'c2a_normal_border_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Button Border Color', 'quiety' ),
                'desc'   => esc_html__( 'You can change menu text color.', 'quiety' ),
                'output' => array(
                    'border-color' => 'header .nav-btn',
                )
            ),

            //Button Sticky Color
            array(
                'id'     => 'c2a_sticky_text_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Sticky Button Text Color', 'quiety' ),
                'output' => array('header.showed .nav-btn')
            ),

            array(
                'id'     => 'c2a_sticky_bg_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Sticky Button Background Color', 'quiety' ),
                'desc'   => esc_html__( 'You can change menu text color.', 'quiety' ),
                'output' => array(
                    'background-color' => 'header.showed .nav-btn',
                )
            ),

            array(
                'id'     => 'c2a_sticky_border_color',
                'type'   => 'color',
                'title'  => esc_html__( 'Sticky Button Border Color', 'quiety' ),
                'desc'   => esc_html__( 'You can change menu text color.', 'quiety' ),
                'output' => array(
                    'border-color' => 'header.showed .nav-btn',
                )
            ),

            array(
                'id'     => 'c2a_btn_border_radius',
                'type'   => 'spacing',
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				'id'          => 'footer_style',
				'type'        => 'select',
				'title'       => __('Select Footer Style', 'quiety' ),
				'options'     => Quiety_Theme_Helper::get_footers_types(),
			),
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				...
				'type'  => 'textarea',
				'title' => esc_html__( 'Default Description', 'quiety' ),
				'desc'  => esc_html__( 'Set the default description for the page header', 'quiety' ),
			),
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				'id'         => 'blog_style',
				'type'       => 'image_select',
				'title'      => esc_html__( 'Style', 'quiety' ),
				'desc'       => esc_html__( 'Display number of post per row', 'quiety' ),
				'radio'      => true,
				'options'    => array(
					'list' => QUIETY_THEME_URI . '/assets/images/layout/list.png',
					'grid' => QUIETY_THEME_URI . '/assets/images/layout/grid.png',
				),
				'default'    => 'list',
			),
...
//				'dependency' => array( 'blog_style', '==', 'grid' ),
			...
			array(
				'id'      => 'word_count',
				'type'       => 'text',
				'title'      => esc_html__( 'Post Content Word Count', 'quiety' ),
				'default'    => 23,
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				'id'    => 'quiety_portfolio_slug',
				'type'  => 'text',
				'title' => esc_html__( 'Portfolio Custom Slug', 'quiety' ),
			),
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				'id'       => 'product_style',
				'type'     => 'button_set',
				'title'    => __('Product Style', 'quiety'),
				'multiple' => false,
				'options'  => array(
					'style_one'   => __('One', 'quiety'),
					'style_two'   => __('Two', 'quiety'),
				),
				'default'  => 'style_one'
			),

...
if ( class_exists( 'CSF' ) ) {
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
            ...
            array(
                'id'       => 'meta_header_container_width',
                'type'     => 'number',
                'title'    => __( 'Menu Container Width', 'quiety' ),
                'default'  => ''
            ),
			...
			array(
				...
				'output' => array(
					...
					.site-header.pix-header-fixed .header-inner .site-nav.nav-two .nav-right .nav-btn, .site-header .site-main-menu li > a:after',
			...
			array(
				...
				'add_title' => esc_html__( 'Upload', 'quiety' ),
				'output'    => array(
					'color'      => '.site-header:not(.mobile-header).header_light .site-main-menu > li > a:hover,
            ...
            array(
                'type'    => 'subheading',
                'content' => esc_html__( 'Call to Action Button', 'quiety' ),
            ),
	...
	CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				...
				'type'       => 'textarea',
				'title'      => esc_html__( 'Page Description', 'quiety' ),
				'desc'       => esc_html__( 'Set custom title for the page header. Default: The post title.', 'quiety' ),
				'dependency' => array( 'meta_page_header', '==', 'enabled' ),
			),
